package com.ksbm_astroexpert.ui.howorks;
...
import com.ksbm_astroexpert.databinding.HowItWorksActivityBinding;
...
public class HowItWorksActivity extends BaseActivity {
    ...
    private HowItWorksActivityBinding binding;
    private BaseProgressRecyclerListAdapter baseRecyclerAdapter;

    @Override
    protected int getLayout() {
        return R.layout.how_it_works_activity;
    }

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = (HowItWorksActivityBinding) getBinding();
        init();
        faq();
    }
    ...
    private void init() {
        ...
        binding.actionbar.txtTitle.setText(R.string.lbl_how_it_works);
    }
    ...
    private void faq() {
        ...
        final String URLALL=RootURL.Base_URL+"/Astroksbmadmin/user/pages.php?id=4";
