package com.ksbm_astroexpert.ui.faqs;
...
import com.ksbm_astroexpert.databinding.FaqsActivityBinding;
...
public class FAQsActivity extends BaseActivity {
    ...
    private FaqsActivityBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = (FaqsActivityBinding) getBinding();
        init();
        faq();
    }
    ...
    private void init() {
        ...
        binding.actionbar.txtTitle.setText(R.string.lbl_faqs);
    }
    ...
    private void faq() {
        ...
        final String URLALL=RootURL.Base_URL+"/Astroksbmadmin/user/pages.php?id=2";
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            Log.i("Dfsfsdffdsdfsdfdf",response.toString());
                            ...
                            /*    comments.setText(jsonObject.getString("comment")+"k mins");
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                   ...
                                   /* if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                                        binding.desc.setText(Html.fromHtml(nini,Html.FROM_HTML_MODE_LEGACY));
                                    }

                                    else
                                    {
                                        binding.desc.setText(Html.fromHtml(nini));
                                    }*/
