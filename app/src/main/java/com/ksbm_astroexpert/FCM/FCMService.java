package com.ksbm_astroexpert.FCM;
...
//    Utils utils = new Utils();
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        Log.v(Tag+"Imagewwdw", remoteMessage.getNotification().getImageUrl()+" ");
        String msg_type = remoteMessage.getNotification().getTitle();
        if(msg_type!=null) {
            if (msg_type.equalsIgnoreCase("chat")) {

            if (getTopAppName().equals(HomeActivity.class.getName())) {
    ...
    private void sendNotification(String messageBody, String action) {
        ...
        notificationBuilder.setSmallIcon(R.drawable.splash)
