package com.ksbm_astroexpert.Chat.holders;
...
import com.ksbm_astroexpert.Chat.activity.FullScreenActivity;
    ...
    public void setRightMessage(String userid, final String message, long time, String type)
    {
        ...
        else
        {
            ...
            messageTextPictureRight.setOnClickListener(new View.OnClickListener()
            {
                ...
                {
                    Log.i("fsddfsdfsdfsdffsdf",message);
        ...
        userListener = new ValueEventListener()
        {
            ...
            public void onDataChange(final DataSnapshot dataSnapshot)
            {
                try
                {
                    ...
                    {
                        messageImageRight.setImageResource(R.drawable.splash);
                    }
                }
                catch(Exception e)
                {
        ...
        userListener = new ValueEventListener()
        {
            ...
            public void onDataChange(final DataSnapshot dataSnapshot)
            {
                try
                {
                    ...
                    {
                        messageImageLeft.setImageResource(R.drawable.splash);
                    }
                }
                catch(Exception e)
                {
