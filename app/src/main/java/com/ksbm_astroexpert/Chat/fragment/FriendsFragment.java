...
import com.ksbm_astroexpert.Chat.holders.FriendHolder;
import com.ksbm_astroexpert.Chat.models.Friend;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        adapter = new FirebaseRecyclerAdapter<Friend, FriendHolder>(options)
        {
            ...
            public void onDataChanged()
            {
                ...
                LinearLayout text = view.findViewById(R.id.f_friends_text);
