...
public class ProfileActivity extends AppCompatActivity
{
        ...
        userListener = new ValueEventListener()
        {
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                try
                {
                    ...
                    {
                        cover.setImageResource(R.drawable.ic_app);
                    }
                }
                catch(Exception e)
                {
    ...
    protected void onActivityResult(int requestCode, int resultCode, final Intent data) {
        ...
        if(requestCode == 1 && resultCode == RESULT_OK) {
            ...
            final StorageReference file = FirebaseStorage.getInstance().getReference().child("profile_images").child(currentUserId + ".jpeg");
                    ...
                    if(task.isSuccessful()) {
                        file.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                final String makeurl = String.valueOf(uri);
                                userDatabase.child("image").setValue(makeurl).addOnCompleteListener(new OnCompleteListener<Void>()
                                {
                                    @Override
            ...
            file.putFile(url).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>()
            {
                ...
                public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task)
                {
                    if(task.isSuccessful()) {
                       ...
                       // Task<Uri> downUrl=task.getResult().getMetadata().getReference().getDownloadUrl();
                        // Updating image on user data
    ...
    public void initMyProfile() {
		...
		button1.setRippleColor(getResources().getColor(R.color.colorAccent));
		button1.setImageResource(R.drawable.add);
        ...
        button2.setRippleColor(getResources().getColor(R.color.yellow));
        button2.setImageResource(R.drawable.add);
        ...
        button3.setRippleColor(getResources().getColor(R.color.colorAccent));
        button3.setImageResource(R.drawable.add);
    ...
    public void setFabMenu(int index)
    {
        ...
        button2.setRippleColor(getResources().getColor(R.color.green));
        switch(index)
        {
            case 0:
        ...
        //----------for hiding sending message----
       /* button3 = new TitleFAB(ProfileActivity.this);
        button3.setTitle("Send Message");
        button3.setBackgroundColor(getResources().getColor(R.color.blue_color_picker));
        button3.setRippleColor(getResources().getColor(R.color.blue_color_picker));
