...
public class RegisterUser1  extends AppCompatActivity implements View.OnClickListener, DatePickerDialog.OnDateSetListener {
...
//                Log.i(TAG,"Error :" + error.toString());
        ...
        Volley.newRequestQueue(RegisterUser1.this).add(mStringRequest);
...
//                Log.i(TAG,"Error :" + error.toString());
    ...
    {
        final ProgressDialog progress = new ProgressDialog(RegisterUser1.this);
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    {
                       // Toast.makeText(RegisterUser1.this, ""+jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
                        sendatatpserver();
                    }
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject jsonObject) {
                        try {
                            ...
                            if (jsonObject.getString("status").equals("1")) {
                                Toast.makeText(RegisterUser1.this, "Profile updated successfully.", Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(getApplicationContext(), HomeActivity.class);
                                startActivity(intent);
                                finish();
                            }
...
//                                Toast.makeText(RegisterUser1.this, jsonObject.getString("message").toString(), Toast.LENGTH_SHORT).show();
                                Toast.makeText(RegisterUser1.this, "Profile not update due to server issue.", Toast.LENGTH_SHORT).show();
//                                finish();
                            }
...
//    }
    ...
    private void alertDate()
    {
        ...
        DatePickerDialog dialog = new DatePickerDialog(RegisterUser1.this, this,
    ...
    private void alertTime()
    {
        ...
        // time picker dialog
        TimePickerDialog picker = new TimePickerDialog(RegisterUser1.this,
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(RegisterUser1.this, OTPVerificationActivity.class);
        startActivity(intent);
        finish();
    }
}