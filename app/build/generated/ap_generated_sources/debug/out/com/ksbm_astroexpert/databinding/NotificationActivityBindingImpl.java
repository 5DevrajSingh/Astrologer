...
public class NotificationActivityBindingImpl extends NotificationActivityBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.rvNotiList, 2);
        sViewsWithIds.put(R.id.txtErrorCaption, 3);
        sViewsWithIds.put(R.id.txtErrorMessage, 4);
    }
    // views
    @NonNull
    ...
    public NotificationActivityBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }
    private NotificationActivityBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
