...
public class ActionbarLayoutBindingImpl extends ActionbarLayoutBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.backarrow, 4);
        sViewsWithIds.put(R.id.txtTitle, 5);
        sViewsWithIds.put(R.id.imgSupport, 6);
        sViewsWithIds.put(R.id.imgNotification, 7);
    }
    // views
    @NonNull
    ...
    public ActionbarLayoutBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 8, sIncludes, sViewsWithIds));
    }
    private ActionbarLayoutBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
